...
public class TrialValidatorTest {
    ...
    @Test
    public void getValidTrialTest() throws InvocationTargetException
    ...
    public void getValidTrialNotEnoughArgumentsTest() throws InvocationTargetException
            , NoSuchMethodException, InstantiationException, IllegalAccessException {
    ...
    @Test(expected = JsonSyntaxException.class)
    public void getValidTrialStringFieldInvalidTest() throws InvocationTargetException
            , NoSuchMethodException, InstantiationException, IllegalAccessException {
        when(jsonObject.size()).thenReturn(3);
        when(jsonObject.get("account")).thenReturn(jsonObject);
    ...
    @Test(expected = JsonSyntaxException.class)
    public void getValidTrialIntegerFieldInvalidTest() throws InvocationTargetException
            , NoSuchMethodException, InstantiationException, IllegalAccessException {
        when(jsonObject.size()).thenReturn(3);
        when(jsonObject.get("account")).thenReturn(jsonObject);
        when(jsonObject.getAsString()).thenReturn("Vasya");
