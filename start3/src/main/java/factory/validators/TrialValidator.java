...
public class TrialValidator {
    ...
    private final Class<? extends Trial> clazz;

    public TrialValidator(Class<? extends Trial> trialClass) {
        this.clazz = trialClass;
    }

    public Trial getValidTrial(JsonObject jsonObject) throws NoSuchMethodException
            , IllegalAccessException, InvocationTargetException, InstantiationException {
        Trial trial = clazz.getConstructor().newInstance();
